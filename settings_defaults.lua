...
SettingsDefaults.DEFAULT_SETTINGS = {
    ...
    crowd_control = {
        ...
        label_color = { 255, 255, 255, 255 },
        timer_color = { 255, 255, 255, 255 },
        urgent_timer_color = { 255, 76, 64, 255 },
        urgent_threshold_ms = 2000,
        edge_flash_enabled = true,
        edge_flash_category_color = true,
        edge_flash_duration_ms = 420,
        edge_flash_intensity = 65,
        edge_flash_thickness = 96,
        edge_flash_cooldown_ms = 750,
        edge_flash_color = { 255, 76, 64, 255 },
        edge_flash_hard = true,
        edge_flash_silence = true,
        edge_flash_root = true,
        edge_flash_slow = false,
        edge_flash_misc = true,
        edge_flash_dot = false,
        show_hard = true,
        show_silence = true,
        show_root = true,
        show_slow = true,
    ...
    mount_glider = {
        ...
        mount_pos_x = 0,
        mount_pos_y = 0,
        mount_position_initialized = false,
        glider_pos_x = 0,
        glider_pos_y = 0,
        glider_position_initialized = false,
        lock_position = false,
        icon_size = 36,
        icon_spacing = 6,
        icons_per_row = 9,
    ...
    style = {
        ...
        target_class_offset_x = 10,
        target_class_offset_y = -36,
        target_pdef_offset_x = 110,
        target_pdef_offset_y = -36,
        target_mdef_offset_x = 190,
        target_mdef_offset_y = -36,
        target_gearscore_offset_x = 10,
        target_gearscore_offset_y = -54,
        target_guild_visible = true,
        target_class_visible = true,
        target_gearscore_visible = true,
        target_gearscore_gradient = false,
        ...
        hostile_target_hp_enabled = false,
        hostile_target_hp_color = { 255, 54, 40, 255 },
